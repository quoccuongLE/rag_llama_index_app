...
_REGISTERED_PARSER_CLS = {}
_REGISTERED_PARSER_CFG = {}
...
def register_builder(key: str):
    ...
    """
    return registry.register(_REGISTERED_PARSER_CLS, key)
...
def get_config(name: str):
    ...
    cfg_creater = registry.lookup(_REGISTERED_PARSER_CFG, name)
    return cfg_creater()


def register_config(key: str):
    return registry.register(_REGISTERED_PARSER_CFG, key)
