"""This code is adapted from the file `marker/convert.py` in the repo marker-pdf
"""
...
def convert_single_pdf_no_images(
...
) -> Tuple[str | list[str], Dict[str, Image.Image], Dict]:
    ...
    if page_merge:
        ...
        for text_block in text_blocks:
            full_text = cleanup_text(text_block.text)
            full_texts.append(replace_bullets(full_text))
        return full_texts, out_meta
